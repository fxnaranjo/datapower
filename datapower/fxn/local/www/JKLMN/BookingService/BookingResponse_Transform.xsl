<xsl:stylesheet version="1.0" extension-element-prefixes="dp" exclude-Result-prefixes="dp str" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dp="http://www.datapower.com/extensions" xmlns:str="http://exslt.org/strings" xmlns:book="http://www.ibm.com/datapower/JKHLE/BookingService/">
   <xsl:template match="/">
      <xsl:apply-templates/>
   </xsl:template>
